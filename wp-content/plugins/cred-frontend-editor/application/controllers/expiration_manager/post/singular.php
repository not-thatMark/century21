...
class Singular {
	 ...
	 * @param int $post_id
	 * @since 2.3
	 * @todo The saving is broken since I rmeoved the AJAX call to calculate the timestamp.
	 *     I will need to get ir back: JS localization is not working properly
	 *     and we get an offset of at least 1 day because of timezones. WTF.
	 */
	public function maybe_save_expiration_date( $post_id ) {
		...
		$expiration_date_object = $this->get_gmt_date_by_time( sanitize_text_field( $expiration_date ) );
