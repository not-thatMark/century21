...
$cfg['blowfish_secret']					= 'rNhLS8,|i}^*nu>c(7KI|)w[M_PW;X&0' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('wordpress') ;    //i.e. array('db1', 'db2') Show only listed databases
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_rniQRJmVSgUwZlAdL9GBptu/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
