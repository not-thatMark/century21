...
class WPV_template{
    ...
    function the_content( $content ) {
		...
		if ( version_compare( PHP_VERSION, '5.4.0' ) >= 0 ) {
			...
			$db = debug_backtrace( DEBUG_BACKTRACE_IGNORE_ARGS, 6 ); // phpcs:ignore PHPCompatibility.FunctionUse.NewFunctionParameters.debug_backtrace_limitFound, PHPCompatibility.Constants.NewConstants.debug_backtrace_ignore_argsFound
		} else {
			$db = debug_backtrace();
		}
		// phpcs:enable
