	...
	if (isset($instance['title'])) :
		...
		<?php
         ...
         ?>
		         ...
		         ?>
		         <div class='rp-thumb'><a href="<?php the_permalink(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/nthumb.png" alt="<?php get_the_tite()?>"></a></div>
		         <?php
		         endif; ?>	
...
add_action( 'widgets_init', 'register_amora_widget' );  
function register_amora_widget() {  
