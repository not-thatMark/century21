...
class InkHiveVideoFeed extends WP_Widget 
{
    function __construct(){
        ...
        parent::__construct('InkHiveVideoFeed', 'amora Videos', $widget_options, $control_options);
    }
    ...
    function widget($args, $instance){
        ...
        if(isset($videos) && is_array($videos)) {
			...
			<?php
				switch( $video['type'] ) {
					case 'youtube':
					echo '<div class="video-image"><a href="http://www.youtube.com/watch?v='.$video['id'].'" target="_blank" alt="'.$video['id'].'" src="youtube" class="video popup">
					<img src="http://img.youtube.com/vi/'.$video['id'].'/mqdefault.jpg"/></a></div>';
				}?>
				</div>
				<?php }
            ?>
