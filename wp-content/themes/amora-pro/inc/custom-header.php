...
function amora_header_style() {
	...
	#masthead {
			...
			background-size: <?php echo get_theme_mod('amora_himg_style','cover'); ?>;
			background-position-x: <?php echo get_theme_mod('amora_himg_align','center'); ?>;
			background-repeat: <?php echo  get_theme_mod('amora_himg_repeat') ? "repeat" : "no-repeat" ?>;
		}
	</style>	
	<?php
}
