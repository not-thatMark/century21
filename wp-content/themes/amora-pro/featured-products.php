...
<!--		--><?php //echo esc_html( get_theme_mod('amora_slider_title','Featured Products') ); ?>
<!--	</div>-->
...
//				        $args = array(
//			        	'post_type' => 'product',
//			        	'posts_per_page' => get_theme_mod('amora_slider_count',10),
//			        	'tax_query' => array(
//								         array(
//								            'taxonomy'      => 'product_cat',
//								            'terms'         => esc_html( get_theme_mod('amora_slider_cat',0) ),
...
<!--	<div class="section-title title-font">-->
<!--		--><?php //echo esc_html( get_theme_mod('amora_box_title','Trending') ) ?>
<!--	</div>-->
...
//								         array(
//								            'taxonomy'      => 'product_cat',
//								            'terms'         => esc_html( get_theme_mod('amora_box_cat',0) ),
//								            'operator'      => 'IN' // Possible values are 'IN', 'NOT IN', 'AND'.
//								         )
//									)
//						);
